...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        buttonAnimate(object: topButton, animation: "slideUp", duration: 3.0, delay: 1.0, force: 1.5)
        buttonAnimate(object: midButton, animation: "slideUp",duration: 3.0, delay: 2.0, force: 1.0)
        
        UIView.animateKeyframes(withDuration: 4.0, delay: 2.0) {
            self.springLabel.textColor = .black
            
            UIView.addKeyframe(withRelativeStartTime: 0.0, relativeDuration: 0.5) {
                self.topButton.backgroundColor = UIColor(red: 87/255, green: 107/255, blue: 224/255, alpha: 1.0)
            }
            UIView.addKeyframe(withRelativeStartTime: 0.0, relativeDuration: 1.0) {
                self.midButton.backgroundColor = UIColor(red: 218/255, green: 128/255, blue: 147/255, alpha: 1.0)
            }
    ...
    private func buttonAnimate(object: SpringButton, animation: String, duration: CGFloat, delay: CGFloat, force: CGFloat) {
